...
def add_features_pro(df, fee=0.0005, horizon=15, k=0.8):
    """
    Feature engineering avanzato + target direzionale ATR-based.
    ...
    # (teniamo: timestamp, log_ret, atr, dist_ema*, rsi, ret*, squeeze, range_compression,
    #  vol_regime, trend_strength, target)
    # ------------------------------------------------------
    drop_cols = [
